...
class ContentListAdapter(private val context: Context, private val contentList: List<ContentItem>, private val onItemClickListener: OnItemClickListener) : RecyclerView.Adapter<ContentListAdapter.ContentListViewHolder>() {
